...
public class SpringSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.sessionManagement(session -> session.invalidSessionUrl("/sessaotimeout?mensagem=expirado")
				...
				.antMatchers("/usuario/trocar-senha-esquecida/**").permitAll().antMatchers("/produto/detalhe/**")
				.permitAll().antMatchers("/produto/formulario/**").hasRole("ADM").antMatchers("/js/**").permitAll()
